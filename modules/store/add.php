...
class View
{
	...
	function Draw()
	{
		...
		<fieldset>
				...
				<p class='item_param'>
					<label for='item_count'>Action ID (necessario para alguns itens especiais, por padrão deixe em branco)</label><br />
				...
				<p>
					<label for='item_price'>Preço (insira o valor sem virgulas, por ex: R$ 10,00 digite 1000)</label><br />
