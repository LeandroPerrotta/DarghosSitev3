...
if($account->canSeeAdPage())
{
	...
	{
		$core->sendMessageBox("Erro!", "Esta pagina só poderá ser visualizada em sua conta a partir de {$core->formatDate($account->getLastAdPage() + 60 * 60 * 24)}.");
	}
}
else
{
