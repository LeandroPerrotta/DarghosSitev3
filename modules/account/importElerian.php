...
if($_SESSION['loginElerian'])
{
	...
	else
	{
		...
		{
			$module .= "
				<p>A sua conta {$acc_fetch->name} em Elerian n�o possuia Conta Premium.</p>
			";			
		}
		...
		{
			$module .= "
				<p>A sua conta {$query->fetch()->name} em Elerian n�o possui nenhum pedido pendente a aceita��o.</p>
			";			
		}	
...
else
{
	if($post)
	{
		...
		if($query->numRows() == 0)
		{
			$error = "Esta conta n�o existia em Elerian ou a senha est� incorreta.";
		}
...
<form action="'.$_SERVER['REQUEST_URI'].'" method="post">
	<fieldset>
		...
		<p>Com este recurso voc� poder� importar sua Conta Premium em andamento de Elerian para esta conta no novo Darghos. Ou ainda importar um pedido pendente de aceita��o. Abaixo preencha os campos com o seu antigo login de Elerian para que o sistema rastreie as opera��es possiveis para sua conta.</p>	
