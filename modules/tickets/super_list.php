<?
	...
	if($account->getGroup() >= 4){
		...
		else 
		{
			...
			$central = "<p><a href='?ref=tickets.super_list&state=closeds'>Ver tickets Fechados</a></p><p>Tickets aguardando resposta. Use um portugu�s adequado para responder o mesmo.</p>";
		}
		$module .=	"
		...
		while($fetch = $query->fetch())
		{
			...
			//n�o h� um personagem, ent�o usamos o personagem com nivel mais alto da conta
			else
			{
