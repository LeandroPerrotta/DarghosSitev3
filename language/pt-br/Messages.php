...
{		
	...
	{		
		...
		self::$messages[$e_Msg->GUILD_INVITE_ALREADY_MEMBER] = "Os seguintes personagens já são membros de outras guildas e não podem ser invitados: @v1@";
		self::$messages[$e_Msg->GUILD_INVITE_ALREADY_INVITED] = "Os seguintes personagens já estão convidados para uma guilda e não podem ser invitados: @v1@";
		self::$messages[$e_Msg->GUILD_INVITE_CHARACTER_NOT_FOUNDS] = "Os seguintes personagens não existem em nosso banco de dados e não podem ser invitados: @v1@";
