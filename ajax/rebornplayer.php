...
if($query && $query->numRows() > 0){	
	$db->query("UPDATE `players` SET `level` = '8', `experience` = '4200', `reborn_level` = '1', health` = '185', `healthmax` = '185', `mana` = '35', `manamax` = '35', `cap` = '470', `town_id` = '6', `posx` = '0', `posy` = '0', `posz` = '0', `vocation` = (`vocation` + 4) WHERE `name` = '{$inputValue}'");
