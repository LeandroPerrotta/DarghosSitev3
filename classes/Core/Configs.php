	...
	static function Init()
	{
		...
		for($i = 0; $i != self::$e_Configs->last(); $i++)
		{
			switch($i)
			{
				...
				case self::$e_Configs->WEBSITE_EMAIL_SUPPORT: self::Set($i, $__configs[$i], "suporte@darghos.com"); break;
				...
				case self::$e_Configs->GUILD_LEADERS_MUST_BE_PREMIUM: self::Set($i, $__configs[$i], false); break;
				case self::$e_Configs->GUILD_VICE_LEADERS_MUST_BE_PREMIUM: self::Set($i, $__configs[$i], false); break;
				...
				case self::$e_Configs->ENABLE_PVP_SWITCH: self::Set($i, $__configs[$i], false); break;					
				case self::$e_Configs->AJAX_SEARCH_PLAYERS_COUNT: self::Set($i, $__configs[$i], 5); break;					
				case self::$e_Configs->ENABLE_BATTLEGROUND_FEATURES: self::Set($i, $__configs[$i], false); break;	
