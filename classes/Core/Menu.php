...
{	
	...
	function __toXML()
	{
		if(Tools::hasFlag($this->conditions, self::CONDITION_MUST_LOGGED) && !Main::isLogged())
			return "";
		elseif(Tools::hasFlag($this->conditions, self::CONDITION_CAN_NOT_LOGGED) && Main::isLogged())
			return "";
		elseif(($this->min_group > 0 && !Main::isLogged()) || (\Framework\Account::loadLogged() && \Framework\Account::loadLogged()->getGroup() < $this->min_group))
			return "";
